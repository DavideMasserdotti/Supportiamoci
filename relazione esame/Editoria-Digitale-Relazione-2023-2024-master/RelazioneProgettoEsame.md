...
L'ente richiede che il prodotto sia facilmente modificabile, in modo da integrare nuove scoperte o iniziative, e che sia semplice da distribuire attraverso le piattaforme social. Per raggiungere questo scopo sono state adottate diverse tecnologie. Lo spazio di lavoro è una directory locale collegata a un repository GitHub. I documenti iniziali sono redatti in Markdown, un formato consolidato, facile da usare e compatibile con molteplici tecnologie. Per il prodotto finale è stato scelto GitBook, una piattaforma che genera un WebBook direttamente dai file Markdown presenti nel repository GitHub. Lo stile del WebBook è stato personalizzato tramite il pannello di controllo di GitBook, che consente di gestire colori, font, layout e altri aspetti grafici.
